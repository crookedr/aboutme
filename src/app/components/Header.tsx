...
export default function Header() {
  ...
  const translatedNavItems = {
    sk: ['Domov', 'O mne', 'Vzdelanie', 'Zručnosti', 'Projekty', 'Kontakt'],
    en: ['Home', 'About', 'Education', 'Skills', 'Projects', 'Contact'],
  }
      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex gap-6 items-center text-sm tracking-wide">
          {navItems.map((item, index) => (
            ...
            >
              {translatedNavItems[language][index]}
